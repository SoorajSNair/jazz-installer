...
You can [install Jazz](https://github.com/soorajsnair/jazz-installer/wiki) in your account using the automated installer.
...
For more details, see the [Wiki](https://github.com/soorajsnair/jazz-installer/wiki).
